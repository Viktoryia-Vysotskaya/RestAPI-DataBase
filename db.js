const db = {
    testimonials: [
        ...
        { id: '3', author: 'Sarah Smith', text: 'Excellent service and great prices.' },
        { id: '4', author: 'Michael Johnson', text: 'I am impressed with their professionalism.' },
        { id: '5', author: 'Emily White', text: 'Best experience I have ever had with a company.' },
        { id: '6', author: 'David Brown', text: 'Highly recommend their services.' },
        { id: '7', author: 'Jessica Lee', text: 'Always reliable and efficient.' },
        { id: '8', author: 'Matthew Clark', text: 'They exceeded my expectations.' },
        { id: '9', author: 'Olivia Harris', text: 'Outstanding customer support.' },
        { id: '10', author: 'Daniel Wilson', text: 'I would not choose any other company.' }
    ],
    concerts: [
